...
3. Vercel project -> Settings -> Environment Variables -> add  WATCH_KEY = NQ0pEOuCgHZhVweL
...
7. cron-job.org -> free account -> Create cronjob
   URL:  https://YOURDOMAIN/api/check?key=NQ0pEOuCgHZhVweL
   Schedule: every 1 minute -> Create.
8. Open  https://YOURDOMAIN/?key=NQ0pEOuCgHZhVweL  once (it remembers the key) -> Send test ping.
